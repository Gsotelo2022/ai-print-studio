...
REM â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
if %OLLAMA_AVAILABLE% equ 1 (
    echo   [START] Iniciando Sistema de Agentes IA
    echo       * Agente Productos (puerto 5001)
    echo       * Agente Precios (puerto 5002)
    start "Agentes IA - Sistema Modular" cmd /k "cd /d "%cd%\agentes-Ollama" && start-all-agentes.bat"
    timeout /t 3 /nobreak >nul
    echo   [OK] Sistema de Agentes iniciado
)
